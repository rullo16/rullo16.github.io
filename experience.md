...
<ul>
    ...
    <ul>
        ...
        <li><strong>Pipeline Manager for Data Quality Optimization:</strong>
            <ul>
                <li>Led a team to develop a custom Pipeline Manager, improving data quality and system performance for external partners.</li>
                <li>Extended StreamPipes capabilities and integrated Grafana for advanced data visualization and analysis.</li>
                <li>Collaborated with the StreamPipes team, fostering strong partnerships and delivering technical presentations to international stakeholders.</li>
