...
<h3>EU Research Project Leadership</h3>
  <ul>
    ...
    <li>
      Serve as the main technical expert for EU funding opportunities related to AI open calls. Act as the technical manager for funded EU research projects, overseeing the technical strategy, coordinating team implementations, and ensuring successful project delivery.
    </li>
  </ul>
...
<h3>Key Contributions</h3>
  <ul>
    ...
    <li>
      <strong>Continuous Control Agent:</strong> Implemented a Soft Actor-Critic (SAC) agent with a Centralised Training with Decentralised Execution (CTDE) paradigm, developing a custom centralised critic network in PyTorch for coordinated policy learning.
    </li>
    <li>
      <strong>Reward Engineering:</strong> Designed a hybrid reward function combining sparse terminal rewards with dense, potential-based progress rewards. Integrated an Intrinsic Curiosity Motivation (ICM) module to solve sparse reward and exploration challenges.
    </li>
    <li>
      <strong>Knowledge Distillation:</strong> Implemented a pipeline to distil features from a pre-trained vision model (VIP) into the agent's CNN, enhancing state representations without the computational overhead of a large network.
    </li>
  </ul>
...
<div style="margin-top: 12px;">
    ...
    <span class="tag">PettingZoo</span>
